...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    p.add_argument("--commands-file", default="gromacs_pca_movie_commands.sh", help="Output file for command logging, relative to --outdir (default: gromacs_pca_movie_commands.sh)")
